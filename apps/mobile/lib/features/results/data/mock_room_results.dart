  ...
  RoomResult(
    ...
    rankedSubmissions: [
      ResultSubmission(
        ...
        authorUserId: 'mock-author-morning-1',
        wins: 8,
        comparisons: 9,
      ...
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-morning-2',
        wins: 7,
        comparisons: 9,
      ...
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-morning-3',
        wins: 6,
        comparisons: 8,
  ...
  RoomResult(
    ...
    rankedSubmissions: [
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-motion-1',
        wins: 7,
        comparisons: 7,
      ...
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-motion-3',
        wins: 4,
        comparisons: 7,
        paletteStart: 0xFFDDBB8D,
        paletteEnd: 0xFF8F5D42,
  ...
  RoomResult(
    ...
    rankedSubmissions: [
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-evening-1',
        wins: 10,
        comparisons: 10,
        paletteStart: 0xFFC66A4A,
        paletteEnd: 0xFF17211C,
      ...
      ResultSubmission(
        ...
        authorLabel: 'Анонимный участник',
        authorUserId: 'mock-author-evening-2',
        wins: 8,
        comparisons: 10,
        paletteStart: 0xFFE9A66F,
