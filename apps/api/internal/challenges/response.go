...
type challengeResponse struct {
	...
	ViewerHasVotingOptions   bool      `json:"viewer_has_voting_options"`
	ViewerHasCompletedVoting bool      `json:"viewer_has_completed_voting"`
...
func toChallengeResponse(challenge Challenge, now time.Time) challengeResponse {
	return challengeResponse{
		...
		ViewerHasSubmission:      challenge.ViewerHasSubmission,
		ViewerHasVotingOptions:   challenge.ViewerHasVotingOptions,
		ViewerHasCompletedVoting: challenge.ViewerHasCompletedVoting,
