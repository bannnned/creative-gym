...
type roomResponse struct {
	...
	ViewerVotesCompleted int       `json:"viewer_votes_completed"`
	ViewerVotesTarget    int       `json:"viewer_votes_target"`
...
func toRoomResponse(room Room, now time.Time) roomResponse {
	return roomResponse{
		...
		ViewerVotesCompleted: room.ViewerVotesCompleted,
		ViewerVotesTarget:    room.ViewerVotesTarget,
